...
public class Links extends TableImpl<LinksRecord> {
     ...
     */
    public final TableField<LinksRecord, String> LINK_TYPE =
        createField(DSL.name("LINK_TYPE"), SQLDataType.VARCHAR(1000000000).nullable(false), this, "");
    /**
     * The column <code>LINKS.UPDATED_AT</code>.
     */
    public final TableField<LinksRecord, LocalDateTime> UPDATED_AT =
        createField(DSL.name("UPDATED_AT"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");
    /**
     * The column <code>LINKS.CHECKED_AT</code>.
     */
    public final TableField<LinksRecord, LocalDateTime> CHECKED_AT =
        createField(DSL.name("CHECKED_AT"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function5<? super Long, ? super String, ? super String, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from
    ) {
