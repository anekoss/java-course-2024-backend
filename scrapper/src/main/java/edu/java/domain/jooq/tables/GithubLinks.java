...
public class GithubLinks extends TableImpl<GithubLinksRecord> {
     ...
     */
    public final TableField<GithubLinksRecord, Long> ID = createField(DSL.name("ID"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>GITHUB_LINKS.LINK_ID</code>.
     */
    public final TableField<GithubLinksRecord, Long> LINK_ID = createField(DSL.name("LINK_ID"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>GITHUB_LINKS.BRANCH_COUNT</code>.
     */
    public final TableField<GithubLinksRecord, Long> BRANCH_COUNT = createField(DSL.name("BRANCH_COUNT"), SQLDataType.BIGINT.nullable(false), this, "");
    ...
    @Override
    @NotNull
    public List<UniqueKey<GithubLinksRecord>> getUniqueKeys() {
    ...
    public Links links() {
        if (_links == null)
            _links = new Links(this, Keys.CONSTRAINT_3A6);
