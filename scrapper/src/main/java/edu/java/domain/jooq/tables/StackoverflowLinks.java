...
public class StackoverflowLinks extends TableImpl<StackoverflowLinksRecord> {
     ...
     */
    public final TableField<StackoverflowLinksRecord, Long> ID = createField(DSL.name("ID"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>STACKOVERFLOW_LINKS.LINK_ID</code>.
     */
    public final TableField<StackoverflowLinksRecord, Long> LINK_ID = createField(DSL.name("LINK_ID"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>STACKOVERFLOW_LINKS.ANSWER_COUNT</code>.
     */
    public final TableField<StackoverflowLinksRecord, Long> ANSWER_COUNT = createField(DSL.name("ANSWER_COUNT"), SQLDataType.BIGINT.nullable(false), this, "");
    ...
    @Override
    @NotNull
    public List<UniqueKey<StackoverflowLinksRecord>> getUniqueKeys() {
    ...
    public List<ForeignKey<StackoverflowLinksRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CONSTRAINT_1CD);
    }
    ...
    public Links links() {
        if (_links == null)
            _links = new Links(this, Keys.CONSTRAINT_1CD);
